...
class ADAuth {
	...
	public $ldap_connected			= false;
	public $ldap_authenticated		= false;
	private $ldap_conn				= null;
	private $ldap_ad_host 			= 'ldaps://dc11.ad.colorado.edu/';
	private $ldap_directory_host 	= 'ldaps://directory.colorado.edu/';
	private $ldap_type 				= "";
	private $ldap_port 				= 636;
	private $ldap_user_prefix 		= 'AD\\';
